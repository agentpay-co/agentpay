...
- Repositioned the project around **private, policy-bounded delegation of money
  to AI agents**: a non-custodial AgentVault under a private, zero-knowledge-
...
- `@agentpay/agent-sdk` (`packages/agent-sdk`): shared scaffolding for
...
- Expanded inline documentation for the AgentVault contract's public entry
...
- AgentVault Soroban contract (`contracts/agent-vault`): deposits,
...
[Unreleased]: https://github.com/agentpay-protocol/agentpay/compare/v0.1.0...HEAD
[0.1.0]: https://github.com/agentpay-protocol/agentpay/releases/tag/v0.1.0
