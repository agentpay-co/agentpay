...
valid under the currently loaded verifying key. AgentVault calls this contract
...
(AgentVault) is the orchestrator; it calls `verify` and only releases funds if
