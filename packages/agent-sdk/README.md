...
Shared scaffolding for AgentPay specialist agents. Factors out the lifecycle
...
import { createAgent } from '@agentpay/agent-sdk';
...
```bash
EXAMPLE_ORACLE_SECRET_KEY=S... npm run example:oracle -w @agentpay/agent-sdk
```
