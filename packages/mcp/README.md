...
A Model Context Protocol (MCP) server that exposes AgentPay's agent discovery, vault operations, and payment building capabilities as MCP tools. This enables AI agents and other MCP-compatible clients to discover and pay for services on the AgentPay network without custom integration.
...
See the main [AgentPay README](../../README.md) for complete system architecture.