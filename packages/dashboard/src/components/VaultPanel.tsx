    ...
    <>
      <div className="bg-gray-900 border border-gray-700 rounded-xl p-4">
        <div className="flex items-center gap-2 mb-4">
          <Vault size={16} className="text-teal-400" />
          <h2 className="text-sm font-semibold text-gray-200">AgentVault</h2>
          <a
          ...
          <>
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                ...
                className="flex items-center justify-center gap-1.5 bg-teal-600 hover:bg-teal-500 text-white text-xs font-medium rounded-lg px-3 py-2 transition-colors"
              >
                <Plus size={12} />
                Fund
              </button>
      ...
      {modal === 'withdraw' && (
        <VaultModal
          title="Withdraw from AgentVault"
          ...
          {isSuccess ? (
              ...
              <div>
                ...
                {txHash && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-xs text-teal-400 hover:text-teal-300 flex items-center gap-1 justify-center mt-1"
                  >
            ...
            <>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="0.00"
                    className="w-full bg-gray-800 border border-gray-700 focus:border-teal-500 rounded-xl pl-7 pr-14 py-2.5 text-sm text-white placeholder-gray-600 outline-none transition-colors"
                  />
              ...
              <button
                ...
                className="w-full bg-teal-600 hover:bg-teal-500 disabled:opacity-40 disabled:cursor-not-allowed text-white text-sm font-semibold rounded-xl px-4 py-2.5 transition-colors"
              >
                {isBusy ? '…' : confirmLabel}
              </button>
            </>
