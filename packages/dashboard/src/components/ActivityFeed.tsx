...
const EVENT_META: Record<string, EventMeta> = {
  task_accepted:           { icon: <Zap size={11} />,          color: 'text-teal-400',  bg: 'bg-teal-950/60 border-teal-900/60' },
  agents_loaded:           { icon: <Activity size={11} />,     color: 'text-blue-400',    bg: 'bg-blue-950/60 border-blue-900/60' },
  agents_scored:           { icon: <Star size={11} />,         color: 'text-teal-400',  bg: 'bg-teal-950/60 border-teal-900/60' },
  ...
  budget_locked:           { icon: <Shield size={11} />,       color: 'text-teal-400',  bg: 'bg-teal-950/60 border-teal-900/60' },
