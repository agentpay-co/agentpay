      ...
      <div className="w-full max-w-xl bg-gray-900 border border-gray-700 rounded-2xl shadow-2xl flex flex-col max-h-[90vh] overflow-hidden">
        ...
        <div className="px-5 pt-5 pb-4 border-b border-gray-800">
          <div className="flex items-start gap-3">
            <div className="w-9 h-9 rounded-xl bg-teal-600/20 border border-teal-600/30 flex items-center justify-center shrink-0 mt-0.5">
                ...
                <div className={`border rounded-xl overflow-hidden transition-colors ${
                  ...
                  {isEditing ? (
                    ...
                    <div className="px-4 py-3 space-y-3">
                      <p className="text-xs text-teal-400 font-medium uppercase tracking-wider">Edit task</p>
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            className="w-full bg-gray-800 border border-gray-700 focus:border-teal-500/50 rounded-lg pl-5 pr-3 py-1.5 text-xs font-mono font-semibold text-teal-300 outline-none transition-all"
                          />
                        </div>
                      </div>
                      ...
                      <div className="flex gap-2">
                        ...
                        <button
                          ...
                          className="flex-1 flex items-center justify-center gap-1.5 text-xs py-2 rounded-lg bg-teal-600 hover:bg-teal-500 disabled:opacity-40 text-white font-medium transition-colors"
                        >
                          <CheckCircle size={10} />
                          Save & Replan
                        </button>
                      ...
                      <div className="flex items-start gap-3 px-4 py-3">
                        ...
                        <button
                          ...
                          className={`mt-0.5 w-4 h-4 rounded border-2 flex items-center justify-center shrink-0 transition-colors ${
                            plan.selected ? 'bg-teal-600 border-teal-600' : 'border-gray-600 hover:border-gray-400'
                          }`}
                        >
        ...
        <div className="px-5 py-4 border-t border-gray-800 space-y-3">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              disabled={!canConfirm}
              className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-teal-600 hover:bg-teal-500 disabled:opacity-40 disabled:cursor-not-allowed text-white text-sm font-semibold transition-all shadow-lg shadow-teal-900/30"
            >
              <Zap size={14} />
              {editing !== null
