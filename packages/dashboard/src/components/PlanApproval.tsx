...
export function PlanApproval({ plan, onDismiss, orchestratorName = 'Your Agent' }: Props) {
  ...
  const timerColor = progressPct > 50 ? 'bg-teal-500' : progressPct > 20 ? 'bg-amber-500' : 'bg-red-500';
      ...
      <div className="w-full max-w-xl bg-gray-900 border border-gray-700 rounded-2xl shadow-2xl flex flex-col max-h-[88vh] overflow-hidden">
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 mb-1">
                <span className="text-xs font-semibold text-teal-400 uppercase tracking-widest">{orchestratorName}'s Plan</span>
        ...
        <div className="px-5 py-4 border-t border-gray-800 flex gap-3">
          ...
          <button
            ...
            disabled={acting !== null}
            className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-teal-600 hover:bg-teal-500 text-white text-sm font-semibold transition-all disabled:opacity-40 shadow-lg shadow-teal-900/30"
          >
            <CheckCircle size={14} />
