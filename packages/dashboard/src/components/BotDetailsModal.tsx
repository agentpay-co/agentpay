    ...
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="w-full max-w-sm bg-gray-900 border border-gray-700 rounded-2xl shadow-2xl">
        ...
        <div className="flex items-center gap-3 px-5 pt-5 pb-4 border-b border-gray-800">
          <div className="w-10 h-10 rounded-xl bg-teal-600/20 border border-teal-600/30 flex items-center justify-center shrink-0">
            ...
            {renaming ? (
              <div className="flex items-center gap-1.5">
                <input
                  ...
                  className="flex-1 bg-gray-800 border border-teal-600/50 rounded-lg px-2 py-1 text-sm text-white outline-none"
                />
