  ...
  return (
    <button
      ...
      className={[
        ...
        wallet.isAvailable
          ? 'border-gray-700 bg-gray-800/60 hover:border-teal-600/60 hover:bg-gray-800 active:scale-[0.99] cursor-pointer'
    ...
    >
      ...
      {wallet.isAvailable ? (
        ...
        <a
          ...
          className="flex items-center gap-1 text-xs text-gray-600 hover:text-teal-400 transition-colors flex-shrink-0"
        >
          <Download size={12} />
        </a>
      )}
    ...
    <div className="min-h-screen bg-gray-950 flex flex-col items-center justify-center px-4">
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8 w-full max-w-md">
        <div className="text-center mb-6">
          <div className="w-10 h-10 bg-teal-900/50 border border-teal-800/50 rounded-xl flex items-center justify-center mx-auto mb-3">
          ...
          <p className="text-sm text-gray-400 leading-relaxed">
            Choose a Stellar wallet to access AgentPay. Your funds stay in your control.
          </p>
        </div>
        ...
        <div className="space-y-2.5 pt-4 border-t border-gray-800">
          {[
            { icon: Shield, title: 'Trustless treasury', desc: 'Your USDC held by AgentVault, not us.' },
            ...
            <div key={title} className="flex items-start gap-2.5">
              <div className="w-6 h-6 bg-teal-900/40 border border-teal-800/40 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
